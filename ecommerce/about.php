...
<body style="overflow-x:hidden; padding-bottom:100px;">
  ...
  <div class="container mt-3 d-flex justify-content-center card pb-3 col-md-6">
    ...
    <form class="col-md-12" action="https://formspree.io/f/xkgngnqe" method="POST" name="_next">
      ...
      <button type="submit" class="btn btn-primary" name="SendMessage">Submit</button>
    </form>
  </div>
