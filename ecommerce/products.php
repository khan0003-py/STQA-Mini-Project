        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                ...
                <div class="figure-caption">
                    ...
                    <p><a href="index.php#login" role="button" class="btn btn-warning text-white" name="addToCart">Add To Cart</a></p>
                    <?php
                    } else {
                    if (check_if_added_to_cart(1)) {
                     echo '<p><a href="#" class="btn btn-warning  text-white" disabled>Added to cart</a></p>';
                        ...
                        ?>
                        <p><a href="cart-add.php?id=1" name="addToCart" value="add" class="btn btn-warning  text-white">Add to cart</a><p>
                        <?php
                        }
                    }
                    ?>
